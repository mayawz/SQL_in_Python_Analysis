# SQL_in_Python_Analysis
Query data with SQL in Python and conduct analysis

Use SQLite db and SQL magic to query data & then conduct basic exploratory analysis
original datasets

Socioeconomic Indicators in Chicago This dataset contains a selection of six socioeconomic indicators of public health significance and a “hardship index,” for each Chicago community area, for the years 2008 – 2012.
